 ...
 *
 * path - the path (Relative to the Authenticated Servlet) for this endpoint to consume.
 *
 * securityChecker - (Optional) - A class implementing @link com.bluefirereader.ballard.ballard.security.SecurityChecker
 *
 *
 */
